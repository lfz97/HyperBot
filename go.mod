...
require (
	...
	trpc.group/trpc-go/trpc-agent-go v1.8.2-0.20260430100419-152bbaa4b4fc
	trpc.group/trpc-go/trpc-agent-go/model/anthropic v1.8.1-0.20260430100419-152bbaa4b4fc
