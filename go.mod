...
require (
	...
	trpc.group/trpc-go/trpc-agent-go v1.8.2-0.20260507095141-364189553684
	trpc.group/trpc-go/trpc-agent-go/model/anthropic v1.8.1-0.20260507095141-364189553684
